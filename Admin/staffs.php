...
<body>
  ...
  <div class="content"  dir="rtl" style="text-align: right;">
    ...
    <div class="actions">
      <button onclick="openaddUserModal()"><i class="fas fa-user-plus"></i> &nbsp; إضافة موظفين</button>
      <form method="POST" id="searchForm" class="search-bar">
        <input type="text" name="search" placeholder="يبحث..." value="<?php echo htmlspecialchars($search); ?>">
      </form>
...
?>
      ...
      <form id="addUserForm" method="POST" action="add_staffs.php">
        ...
        <div class="modal-content">
          <div class="input-group">
            ...
            <label for="firstName" class="label">الإسم الاول</label>
          </div>
        </div>
        ...
        <div class="modal-content">
          <div class="input-group">
            ...
            <label for="lastName" class="label">الإسم الاخير</label>
          </div>
        </div>
        ...
        <div class="modal-content">
          <div class="input-group">
            ...
            <label for="contact" class="label">رقم الهاتف</label>
          </div>
        </div>
        <div class="modal-content">
          <div class="input-group">
            <select name="role" id="role" class="input" required>
              ...
              <option value="superadmin">مسؤول عام</option>
              <option value="delivery boy">رجل التوصيل</option>
              <option value="waiter">موظف</option>
            </select>
            <label for="role" class="label">المسمى الوظيفي</label>
          </div>
        </div>
        ...
        <div class="modal-content">
          <div class="input-group">
            ...
            <label for="password" class="label">كلمه المرور</label>
          </div>
        </div>

        <div class="modal-footer">
          <button type="button" class="button" onclick="closeaddUserModal()">إلغاء</button>
  ...
  <div id="editUserModal" class="modal" dir="rtl" style="text-align: right;">
    <div class="modal-overlay"></div>
      ...
      <form id="editUserForm" method="POST" action="edit_staffs.php">
        ...
        <div class="modal-content">
          <div class="input-group">
            ...
            <label for="editEmail" class="label">البريد الإلكتروني</label>
          </div>
          <div class="input-group">
            <input type="text" name="firstName" id="editFirstName" class="input" required>
            <label for="editFirstName" class="label">الإسم الاول</label>
          </div>
          <div class="input-group">
            <input type="text" name="lastName" id="editLastName" class="input" required>
            <label for="editLastName" class="label">الإسم الاخير</label>
          </div>
          <div class="input-group">
            <input type="text" name="contact" id="editContact" class="input" required>
            <label for="editContact" class="label">رقم الهاتف</label>
          </div>
          ...
          <div class="input-group" style="padding-bottom: 20px;">
            <select name="role" id="editRole" class="input" required>
              <option value="">المسمى الوظيفي</option>
              <option value="admin">مسؤول</option>
              <option value="superadmin">المسؤول عام</option>
              <option value="delivery boy">رجل التوصيل</option>
            </select>
            <label for="editRole" class="label">المسمى الوظيفي</label>
          </div>
          ...
          <div class="input-group">
            ...
            <label for="editPassword" class="label">كلمه المرور</label>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="button" onclick="closeEditUserModal()">إلغاء</button>
          <button type="submit" class="button">حفظ</button>
        </div>
      </form>
    </div>
