...
<head>
  ...
  <title>إدارة المستخدمين الإداريين</title>
  <!-- Poppins -->
...
<body>
  ...
  <div class="content" dir="rtl" style="text-align: right;">
    ...
    <div class="actions">
      <button onclick="openaddUserModal()"><i class="fas fa-user-plus"></i> &nbsp; إضافة مستخدم</button>
...
if ($result->num_rows > 0) {
  ...
  echo "<tr><td colspan='8' style='text-align: center;'>لم يتم العثور على مستخدمين</td></tr>";
}
$conn->close();
?>
      </tbody>
  ...
  <div id="addUserModal" class="modal" dir="rtl" style="text-align: right;">
