...
<head>
    ...
    <title>إدارة قائمة المسؤول</title>
  ...
  <div class="sidebar"dir="rtl" style="text-align: right;">
    ...
    <div class="profile-section">
      ...
      <div class="info">
        ...
        <ul>
            ...
            <li><a href="admin_menu.php" class="active"><i class="fas fa-utensils"></i> إدارة القوائم</a></li>
    ...
    <div class="content" dir="rtl" style="text-align: right;">
        <div class="header">
            ...
            <h2><i class="fas fa-utensils"></i>إدارة القوائم</h2>
        </div>
        <div class="modal-row">
            <div>
                <button onclick="openModal()"><i class="fas fa-plus"></i> &nbsp;إضافة القسم جديدة</button>
                <button onclick="openItemModal()"> <i class="fas fa-plus"></i> &nbsp;إضافة عنصر جديد</button>
                <button onclick="openViewCategoryModal()"> <i class="fas fa-eye"></i> &nbsp;عرض الاقسام</button>
            </div>
...
if (mysqli_num_rows($result) > 1) {
    ...
    echo "<tr><td colspan='8' style='text-align: center;'>لم يتم العثور على عناصر قائمة</td></tr>";
}
?>
    ...
    <div class="modal" id="categoryModal" dir="rtl" style="text-align: right;">
            ...
            <form class="form" method="POST" action="add_category.php">
                ...
                <div class="modal-content">
                    <div class="input-group">
                        ...
                        <label for="catName" class="label">اسم الفئة</label>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="button" onclick="closeModal()">الغاء</button>
    ...
    <div class="modal" id="itemModal" dir="rtl" style="text-align: right;">
        <div class="modal-overlay"></div>
        <div class="modal-container">
            <form class="form" method="POST" action="add_item.php" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="input-group">
                        ...
                        <label for="itemName" class="label">اسم الصنف</label>
                    </div>
                    <div class="input-group">
                        <input type="text" name="description" id="description" class="input" required>
                        <label for="description" class="label">وصف</label>
                    </div>
                    <div class="input-group">
                        ...
                        <label for="status" class="label">حالة</label>
                    </div>
...
?>
                        ...
                        <label for="catName" class="label">القسم</label>
                    </div>
                    <div class="input-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="button" onclick="closeItemModal()">إلغاء</button>
                    <button type="submit" class="button">حفظ</button>
                </div>
            </form>
        </div>
            ...
            <form class="form" method="POST" action="edit_item.php" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="input-group">
                        ...
                        <label for="editItemName" class="label">اسم الصنف</label>
                    </div>
                    <div class="input-group">
                        <input type="text" name="description" id="editDescription" class="input" required>
                        <label for="editDescription" class="label">وصف</label>
                    </div>
                    <div class="input-group">
                        ...
                        <label for="editStatus" class="label">حالة</label>
                    </div>
                    <div class="input-group">
                        <input type="number" name="price" id="editPrice" class="input" required>
                        <label for="editPrice" class="label">السعر</label>
                    </div>
                    <div class="input-group">
...
?>
                        ...
                        <label for="editCatName" class="label">القسم</label>
                    </div>

                    <div class="input-group">
                        <input type="file" name="image" id="editImage" class="input" accept="image/*">
                        <small>اترك هذا الحقل فارغًا إذا لم تقم بتغييره.</small>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="button" onclick="closeEditItemModal()">إلغاء</button>
                    <button type="submit" class="button">حفظ</button>
                </div>
            </form>
        </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<tr><td colspan='2'>لم يتم العثور على فئات</td></tr>";
}
?>
                        </tbody>
                    </table>
            ...
            <div class="modal-footer" style="border-top: 1px solid #ffc9b3">
                <button type="button" class="button" onclick="closeViewCategoryModal()">إلغاء</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function deleteCategory(catName) {
            if (confirm(`هل أنت متأكد من رغبتك في حذف الفئة؟ ${catName}?`)) {
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === XMLHttpRequest.DONE) {
                        if (xhr.status === 200) {
                            ...
                            alert("فشل حذف الفئة. يرجى المحاولة مرة أخرى.");
                        }
                    }
                };
