...
<body>
  <div class="sidebar"dir="rtl" style="text-align: right;">
    ...
    <ul>
      ...
      <li><a href="reservations.php"><i class="fas fa-calendar-alt" style="margin-right: 10px;"></i> الحجوزات</a></li>
  ...
  <div class="content" dir="rtl" style="text-align: right;">
    ...
    <div>
      ...
      <div class="buttons-container">
        <button onclick="openaddReservationModal()"><i class="fas fa-calendar-plus"></i> &nbsp; إضافة حجز</button>
        <div class="actions">
          <select id="statusFilter" name="statusFilter" onchange="filterByStatus()">
            <option value="">الكل</option>
            <option value="Pending">قيد الانتظار</option>
            <option value="Approved">موافقة</option>
            <option value="On Process">قيد العمل</option>
          ...
          <button type="button" onclick="clearFilter()">تحديث</button>
        </div>
      </div>
      <table id="userTable">
        <thead>
      ...
      <td>
        <select id='status-{$row['reservation_id']}' onchange=\"updateStatus('{$row['reservation_id']}', this.value)\" class='status-select'>
          ...
          <option value='On Process' " . ($row['status'] == 'On Process' ? 'selected' : '') . ">قسد العمل</option>
          <option value='Completed' " . ($row['status'] == 'Completed' ? 'selected' : '') . ">مكتمل</option>
          <option value='Cancelled' " . ($row['status'] == 'Cancelled' ? 'selected' : '') . ">تم الإلغاء</option>
        </select>
      </td>
      <td>
        ...
        <form id="addReservationForm" method="POST" action="add_reservation.php">
          ...
          <div class="modal-content">
            <div class="input-group">
              ...
              <label for="name" class="label">الإسم</label>
            </div>
          </div>
          ...
          <div class="modal-content">
            <div class="input-group">
              ...
              <label for="noOfGuests" class="label">عدد</label>
            </div>
          </div>
          ...
          <div class="modal-content">
            <div class="input-group">
              ...
              <label for="reservedDate" class="label">التاريخ المحجوز</label>
            </div>
          </div>
          ...
          <div class="modal-content">
            <div class="input-group">
              ...
              <label for="reservedTime" class="label">الوقت المحجوز</label>
            </div>
          </div>
