...
// Check if user data was found, otherwise redirect to login
if ($user === null) {
...
<body>
  ...
  <div class="title mb-4">
    <h3>اهلا <?php echo $user['firstName'] . " " . $user['lastName']; ?>تفضل، هذه سلة التسوق الخاصة بك!</h3>
  </div>

  <div class="cart-details" dir="rtl" style="text-align: right;">
    <div class="cart-items">
      <h4 class="mt-2">محتويات السلة</h4>
      <hr>
      <ul class="list-group">
            ...
            <li class="d-flex justify-content-between align-items-center mb-3 list-group-item">
              ...
              <div class="mt-1">
                <div class="d-flex flex-row justify-content-between align-items-start quantity-price">
                  <div>
                    YER <span class="item-price"><?= $item['price'] ?></span> x <span class="item-quantity"><?= $item['quantity'] ?></span>
                  </div>
                </div>
    ...
    <div class="order-summary">
      ...
      <div class="summary-details payment">
        ...
        <div>
          ...
          <label for="Takeaway">عند التوصيل</label>
        </div>
      ...
      <form id="checkout-form" action="order_review.php" method="post">
        ...
        <button type="button" id="checkout-button">الدفع</button>
      </form>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateDeliveryFee() {
        ...
        deliveryFee = selectedPaymentMode === 'الطبق جاهز' ? 0 : 130;
        updateSummary();
      }
      ...
      function updateQuantity(element, change, isInput = false) {
        ...
        itemContainer.querySelector('.item-total-price').textContent = 'YER ' + itemTotalPrice;
